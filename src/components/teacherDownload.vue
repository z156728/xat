<template>
	<div class="menus">
		<div class="items">
			...
			<div class="titles">
				<div class="imgss">
					<img src="../assets/img/downLoadImgs.png" class="menu-logo" />
			...
			oDiv.onclick = function() { //给元素增加点击事件
				...
				if(n.indexOf('Android') > -1 || n.indexOf('Linux') > -1) { //安卓手机
					...
					if(isWeixin) {
						...
						window.location.href = "http://p.sxxat.com/apk/xat_js.apk";
					}
					
				} else if(n.indexOf('iPhone') > -1) { //苹果手机
					console.log("苹果手机");
					window.location.href = "https://itunes.apple.com/cn/app/id1431645055?mt=8";　　
				}
			};
